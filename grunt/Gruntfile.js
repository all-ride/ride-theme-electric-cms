    ...
    grunt.initConfig({
        ...
        sass: {
            dist: {
                ...
                files: {
                    'build/css/front.css': 'sass/front.scss',
                    'build/css/cms.css': 'sass/cms.scss',
                }
            }
        },
        ...
        legacssy: {
            dist: {
                files: {
                    'build/css/front-legacy.css': 'build/css/front.css',
                    'build/css/cms-legacy.css': 'build/css/cms.css'
                },
            }
        },
